...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "bg-card text-card-foreground flex flex-col gap-5 rounded-[10px] border border-border transition-all duration-200 ease",
        "shadow-[0_1px_3px_rgba(0,0,0,0.04),0_1px_2px_rgba(0,0,0,0.02)] hover:shadow-[0_4px_6px_rgba(0,0,0,0.06),0_2px_4px_rgba(0,0,0,0.04)]",
        className,
      )}
      {...props}
    />
